...
```sh
flowpipe pipeline run detect_and_correct_storage_accounts_with_incorrect_tags --var-file tags.fpvars --arg='approvers=["default"]'
```
...
storage_accounts_with_incorrect_tags_trigger_scheduled = "1h"
incorrect_tags_default_action                          = "apply"
