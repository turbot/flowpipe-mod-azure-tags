trigger "query" "detect_and_correct_mssql_elasticpools_with_incorrect_tags" {
  ...
  schedule = var.mssql_elasticpools_with_incorrect_tags_trigger_schedule
  database = var.database
  sql      = local.mssql_elasticpools_with_incorrect_tags_query
...
variable "mssql_elasticpools_tag_rules" {
  type = object({
